  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-sohngil-primary-dark">최대 5개까지 선택 가능합니다</p>
      </div>
          ...
          <Button
            ...
            className={`rounded-full ${
              activeCategory === category 
                ...
                : 'border-sohngil-primary text-sohngil-primary hover:bg-sohngil-primary/10'
            }`}
          >
            {category}
          </Button>
      ...
      {selectedSymptoms.length > 0 && (
        <Card className="bg-sohngil-primary/5 border-sohngil-primary/20">
              ...
              {selectedSymptoms.map(symptomId => {
                ...
                return symptom ? (
                  <Badge 
                    key={symptomId}
                    variant="secondary"
                    className="bg-sohngil-primary text-white cursor-pointer hover:bg-sohngil-primary-dark"
              ...
              <Button
                ...
                className={`p-4 h-auto flex flex-col items-center gap-2 transition-all duration-200 ${
                  selectedSymptoms.includes(symptom.id)
                    ? 'bg-sohngil-primary text-white hover:bg-sohngil-primary-dark shadow-lg scale-105'
                    : 'border-sohngil-primary/30 hover:border-sohngil-primary hover:bg-sohngil-primary/5'
                }`}
      ...
      <Button
        ...
        className="w-full py-4 text-lg font-semibold bg-gradient-to-r from-sohngil-primary to-sohngil-secondary hover:from-sohngil-primary-dark hover:to-sohngil-secondary-dark disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transition-all duration-300"
      >
